...
/*
**  Define a function named uart_put_string which transmits the contents of 
...
/*
**  Define a function named uart_get_string which uses uart_getbyte to fetch 
...
void process() {
    ...
    if (is_sender) {
        ...
        uart_put_string(messages_to_send[next_message]);
        next_message ++;
        ...
        uart_get_string(buffer, BUFF_SIZE);
